...
const GREETING: ChatMessage = {
  role: "model",
  text: "Hi, I'm Wingman! Ask me where to go for demand, how much you can earn, or anything about your dues — I'm here to help.",
};
...
export default function DriverAIChat() {
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            {QUICK_PROMPTS.map((prompt) => (
              <button
                ...
                className="text-xs font-medium text-[#7C3AED] bg-[#F3E8FF] dark:bg-[#2D1B4E] px-3 py-1.5 rounded-full hover:opacity-80 transition-opacity"
              >
                {prompt}
              </button>
            ))}
